...
urlpatterns = [
 ...
 path('personal/archived/bulk-restore/', views.personal_board_bulk_restore, name='personal_board_bulk_restore'),
 path('personal/archived/bulk-delete/', views.personal_board_bulk_delete, name='personal_board_bulk_delete'),
 path('personal/archived/auto-purge/', views.personal_board_auto_purge, name='personal_board_auto_purge'),
 path('personal/reorder/', views.personal_board_reorder, name='personal_board_reorder'),
    ...
    path('personal/tasks/<int:task_id>/duplicate/', views.personal_task_duplicate, name='personal_task_duplicate'),
